...
\copy company_dim FROM '\Users\rabin\Downloads\csv_files-20260719T102959Z-1-001\csv_files\company_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_dim FROM '\Users\rabin\Downloads\csv_files-20260719T102959Z-1-001\csv_files\skills_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy job_postings_fact FROM '\Users\rabin\Downloads\csv_files-20260719T102959Z-1-001\csv_files\job_postings_fact.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_job_dim FROM '\Users\rabin\Downloads\csv_files-20260719T102959Z-1-001\csv_files\skills_job_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
